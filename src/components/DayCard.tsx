...
export function DayCard({ item, index, unlocked, viewed, completedGame, onClick }: DayCardProps) {
  ...
  return (
    <button
      ...
      className={`card-in day-card group relative min-h-44 overflow-hidden rounded-[1.75rem] border p-4 text-left transition duration-300 active:scale-[0.97] sm:min-h-48 sm:p-5 ${
        unlocked
